// Acces the DOM elements in JavaScript
...
// boxClickedfunction will take the event as an argument
...
// Let's seePlayeWon function now!
const playerWon = () => {
    ...
    if (spaces[4] === currentPlayer) {
        ...
        if (spaces[3] === currentPlayer && spaces[5] == currentPlayer) {
            strategy.innerText = `${currentPlayer} wins horizontally on middle`;
            return true;
        }
...
// Let's create the drasw function
...
// Let's create the restart function
const restart = () => {
    setTimeout(() => {
        spaces.forEach((space, i) => {
            spaces[i] = null;
